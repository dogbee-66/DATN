                ...
                <div class="col" style="--w-md: 4">
                    <div class="footer__block pd-top">
                        <div class="footer__logo">
                            <img src="./assets/images/logo/play.png" alt="logo">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col pd-top d-flex align-center" style="--w-md:4;">
                    <ul class="social__items d-flex align-center">
                        ...
                        <li class="social__item">
                            <a class="" href="https://tiktok.com/@leu.FCQ">
                                <img class="svg__icon d-block" src="./assets/images/icon/tiktok.svg" alt="" />
                            </a>
                        </li>
                        <li class="social__item">
                            <a class="" href="https://youtube.com/@LeuFCQ">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <p class="footer__copy--right">© 2023, theme-shopify design by FCQ</p>
                    </div>
                </div>
            </div>
        </div>
