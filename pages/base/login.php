        ...
        <div class="form-value">
            <form action="pages/handle/login.php" autocomplete="on" method="POST">
                ...
                <div class="forget">
                    ...
                    <a href="index.php?page=forget_password" style="float: right; color: white;">Forget Password</a>

                </div>
                
                <button type="submit" name="login">Đăng nhập</button>
                <div class="register">
                    <p>Chưa có tài khoản ấn <a href="index.php?page=register">Đăng ký</a></p>
                </div>
            </form>
        </div>
    </div>
